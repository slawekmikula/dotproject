...
<tr>
	<td>
		<input class="button" type="Button" name="Cancel" value="<?php echo $AppUI->_('cancel');?>" onClick="javascript:if(confirm('Are you sure you want to cancel.')){location.href = './index.php?m=timecard&tab=0';}">
	</td>
	<td align="right">
